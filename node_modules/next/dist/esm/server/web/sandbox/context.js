 ...
 */ export async function clearModuleContext(path, content) {
    const handleContext = (key, cache, context)=>{
        var _cache_paths_get;
        const prev = (_cache_paths_get = cache == null ? void 0 : cache.paths.get(path)) == null ? void 0 : _cache_paths_get.replace(WEBPACK_HASH_REGEX, "");
