...
import { streamFromArray, streamToString, chainStreams, createBufferedTransformStream, renderToInitialStream, continueFromInitialStream } from "./stream-utils/node-web-streams-helper";
...
export async function renderToHTML(req, res, pathname, query, renderOpts) {
    ...
    const { err , dev =false , ampPath ="" , pageConfig ={} , buildManifest , reactLoadableManifest , ErrorDebug , getStaticProps , getStaticPaths , getServerSideProps , isDataReq , params , previewProps , basePath , images , runtime: globalRuntime , App  } = renderOpts;
    ...
    return new RenderResult(chainStreams(streams).pipeThrough(createBufferedTransformStream(postOptimize)), renderResultMeta);
}
