...
export const createServerHandler = async ({ port , hostname , dir , dev =false , minimalMode  })=>{
    var _nextConfig_experimental, _routerWorker__workerPool;
    ...
    const routerWorker = new Worker(require.resolve("./render-server"), {
        ...
        forkOptions: {
            env: {
                FORCE_COLOR: "1",
                ...process.env,
                __NEXT_PRIVATE_PREBUNDLED_REACT: (nextConfig == null ? void 0 : (_nextConfig_experimental = nextConfig.experimental) == null ? void 0 : _nextConfig_experimental.useServerActions) ? "experimental" : "next"
            }
        },
        exposedMethods: [
            "initialize"
