   ...
   */ async prepare() {
    ...
    async renderToResponseWithComponentsImpl({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        const doRender = async ()=>{
            ...
            if (match && isRouteMatch(match, RouteKind.APP_ROUTE)) {
            ...
            } else if (match && isRouteMatch(match, RouteKind.PAGES) && process.env.NEXT_RUNTIME !== "edge" && components.ComponentMod.routeModule) {
                const module = components.ComponentMod.routeModule;
                ...
                // above.
                result = await module.render(req.originalRequest, res.originalResponse, pathname, query, renderOpts);
            } else {
