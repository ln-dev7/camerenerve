...
async function fetchServerAction(state, param) {
    ...
    const res = await fetch("", {
        ...
        headers: {
            ...
            ...process.env.__NEXT_ACTIONS_DEPLOYMENT_ID && process.env.__NEXT_DEPLOYMENT_ID ? {
 ...
 */ export function serverActionReducer(state, action) {
    ...
    try {
        ...
        const { actionResult , actionFlightData , redirectLocation , revalidatedParts  } = readRecordValue(action.mutable.inFlightServerAction);
