    ...
    if (((_buildInfo_rsc = buildInfo.rsc) == null ? void 0 : _buildInfo_rsc.type) === RSC_MODULE_TYPES.client) {
        ...
        if (assumedSourceType === "module") {
            if (clientRefs.includes("*")) {
                return callback(new Error(`It's currently unsupported to use "export *" in a client boundary. Please use named exports instead.`));
            }
            let esmSource = `\
...
export { e${cnt++} as ${ref} };`;
    ...
    return callback(null, source.replace(RSC_MOD_REF_PROXY_ALIAS, moduleProxy), sourceMap);
}
