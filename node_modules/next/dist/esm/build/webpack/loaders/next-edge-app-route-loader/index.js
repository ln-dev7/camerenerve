...
const EdgeAppRouteLoader = async function() {
    ...
    const modulePath = `${appDirLoader}${stringifiedPagePath.substring(1, stringifiedPagePath.length - 1)}?${WEBPACK_RESOURCE_QUERIES.edgeSSREntry}&${WEBPACK_RESOURCE_QUERIES.metadata}`;
    return `
