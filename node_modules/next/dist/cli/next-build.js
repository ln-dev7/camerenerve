...
const nextBuild = (argv)=>{
    ...
    return (0, _build.default)(dir, args["--profile"], args["--debug"] || process.env.NEXT_DEBUG_BUILD, !args["--no-lint"], args["--no-mangling"], args["--experimental-app-only"], args["--experimental-turbo"], args["--build-mode"] || "default").catch((err)=>{
        console.error("");
