...
async function renderToHTML(req, res, pathname, query, renderOpts) {
    ...
    return new _renderresult.default((0, _nodewebstreamshelper.chainStreams)(streams).pipeThrough((0, _nodewebstreamshelper.createBufferedTransformStream)(postOptimize)), renderResultMeta);
}
