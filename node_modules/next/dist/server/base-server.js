    ...
    constructor(options){
        ...
        if (process.env.NEXT_RUNTIME !== "edge") {
            if (this.nextConfig.experimental.deploymentId) {
                process.env.__NEXT_DEPLOYMENT_ID = this.nextConfig.experimental.deploymentId;
            }
        }
        this.renderOpts = {
   ...
   */ async prepare() {
    ...
    async renderToResponseWithComponentsImpl({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        const doRender = async ()=>{
            ...
            if (match && (0, _routematch.isRouteMatch)(match, _routekind.RouteKind.APP_ROUTE)) {
            ...
            } else if (match && (0, _routematch.isRouteMatch)(match, _routekind.RouteKind.PAGES) && process.env.NEXT_RUNTIME !== "edge" && components.ComponentMod.routeModule) {
                const module1 = components.ComponentMod.routeModule;
                ...
                // above.
                result = await module1.render(req.originalRequest, res.originalResponse, pathname, query, renderOpts);
            } else {
