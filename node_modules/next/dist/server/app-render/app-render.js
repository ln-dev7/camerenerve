   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
     ...
     */ const getDynamicParamFromSegment = (// [slug] / [[slug]] / [...slug]
        ...
        const getLayerAssets = ({ layoutOrPagePath , injectedCSS: injectedCSSWithCurrentLayout , injectedFontPreloadTags: injectedFontPreloadTagsWithCurrentLayout  })=>{
            ...
            const preloadedFontFiles = layoutOrPagePath ? (0, _getpreloadablefonts.getPreloadableFonts)(clientReferenceManifest, nextFontManifest, layoutOrPagePath, injectedFontPreloadTagsWithCurrentLayout) : null;
            if (preloadedFontFiles) {
                if (preloadedFontFiles.length) {
                    for(let i = 0; i < preloadedFontFiles.length; i++){
                        ...
                        const type = `font/${ext}`;
                        const href = `${assetPrefix}/_next/${fontFilename}${getAssetQueryString(false)}`;
       ...
       */ const walkTreeWithFlightRouterState = async ({ createSegmentPath , loaderTreeToFilter , parentParams , isFirst , flightRouterState , parentRendered , rscPayloadHead , injectedCSS , injectedFontPreloadTags , rootLayoutIncluded , asNotFound  })=>{
         ...
         */ const renderComponentsOnThisLevel = // No further router state available
                ...
                if (layoutPath) {
                    ...
                    (0, _getpreloadablefonts.getPreloadableFonts)(clientReferenceManifest, nextFontManifest, layoutPath, injectedFontPreloadTagsWithCurrentLayout);
                }
     ...
     */ const ServerComponentsRenderer = (0, _createservercomponentsrenderer.createServerComponentRenderer)(async (props)=>{
            ...
            return /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, styles, /*#__PURE__*/ _react.default.createElement(AppRouter, {
                ...
                initialHead: /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, createMetadata(loaderTree), appUsingSizeAdjust ? /*#__PURE__*/ _react.default.createElement("meta", {
                    name: "next-size-adjust"
                }) : null),
                globalErrorComponent: GlobalError,
                notFound: NotFound && RootLayout ? /*#__PURE__*/ _react.default.createElement(RootLayout, {
                    params: {}
                }, createMetadata(emptyLoaderTree), notFoundStyles, /*#__PURE__*/ _react.default.createElement(NotFound, null)) : undefined,
                asNotFound: props.asNotFound
