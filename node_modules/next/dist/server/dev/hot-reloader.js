                ...
                await Promise.all(Object.keys(entries).map(async (entryKey)=>{
                    ...
                    await (0, _entries.runDependingOnPageType)({
                        ...
                        onServer: ()=>{
                            ...
                            } else if (!(0, _isapiroute.isAPIRoute)(page) && !(0, _utils.isMiddlewareFile)(page) && !(0, _isinternalpathname.isInternalPathname)(relativeRequest) && !(0, _utils.isInstrumentationHookFile)(page)) {
