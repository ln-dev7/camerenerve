...
function getDefineEnv({ dev , config , distDir , isClient , hasRewrites , isNodeServer , isEdgeServer , middlewareMatchers , clientRouterFilters , previewModeId , fetchCacheKeyPrefix , allowedRevalidateHeaderKeys  }) {
    ...
    return {
        ...
        "process.env.__NEXT_DEPLOYMENT_ID": JSON.stringify(config.experimental.deploymentId),
    ...
    const resolveConfig = {
        ...
        alias: {
            ...
            ...isEdgeServer ? {
                ...
                [require.resolve("next/dist/client/components/navigation")]: "next/dist/esm/client/components/navigation",
                [require.resolve("next/dist/client/components/headers")]: "next/dist/esm/client/components/headers"
            } : undefined,
