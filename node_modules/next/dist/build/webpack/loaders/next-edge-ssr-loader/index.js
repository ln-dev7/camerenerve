...
const edgeSSRLoader = async function edgeSSRLoader() {
    ...
    ${incrementalCacheHandlerPath ? `import incrementalCacheHandler from "${incrementalCacheHandlerPath}"` : "const incrementalCacheHandler = null"}
