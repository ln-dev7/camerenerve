...
const buffer = Buffer.from(${JSON.stringify((await _fs.default.promises.readFile(resourcePath.replace("?" + _constants.WEBPACK_RESOURCE_QUERIES.metadata, ""))).toString("base64"))}, 'base64'
  )
