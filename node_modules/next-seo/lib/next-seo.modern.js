  ...
  if (config.additionalMetaTags && config.additionalMetaTags.length > 0) {
    config.additionalMetaTags.forEach(_ref => {
      ...
      let {
        ...
        tag = _objectWithoutPropertiesLoose(_ref, _excluded$x);
...
const _excluded$w = ["type", "keyOverride", "scriptKey", "scriptId", "dataArray", "useAppDir"];
...
const _excluded$v = ["reviewRating", "author", "publisher"];
...
const _excluded$u = ["thumbnailUrls", "hasPart", "watchCount", "publication"];
...
const _excluded$t = ["type", "keyOverride", "ofType", "data"],
...
const _excluded$s = ["type", "keyOverride", "url", "title", "images", "section", "dateCreated", "datePublished", "dateModified", "authorName", "authorType", "publisherName", "publisherLogo", "body", "isAccessibleForFree"];
...
const _excluded$r = ["type", "keyOverride", "baseSalary", "hiringOrganization", "applicantLocationRequirements", "experienceRequirements", "jobLocation"];
...
const _excluded$q = ["type", "keyOverride", "address", "geo", "rating", "review", "action", "areaServed", "makesOffer", "openingHours", "images"];
...
const _excluded$p = ["type", "keyOverride", "mainEntity"],
...
const _excluded$o = ["type", "keyOverride", "breadcrumb"];
...
const _excluded$n = ["type", "keyOverride", "potentialActions"];
...
const _excluded$m = ["type", "keyOverride", "authorName", "images", "yields", "category", "cuisine", "calories", "aggregateRating", "video", "ingredients", "instructions"];
...
const _excluded$i = ["type", "keyOverride", "location", "images", "offers", "aggregateOffer", "performers", "organizer", "eventStatus", "eventAttendanceMode"];
...
const _excluded$h = ["type", "keyOverride", "contactPoint"];
...
const _excluded$g = ["type", "keyOverride", "hasPart"];
...
const _excluded$f = ["type", "keyOverride", "images", "brand", "reviews", "aggregateRating", "manufacturerLogo", "manufacturerName", "offers", "aggregateOffer", "productName"];
...
const _excluded$e = ["type", "keyOverride", "priceCurrency", "price", "aggregateRating", "review"];
...
const _excluded$d = ["type", "keyOverride"];
...
const _excluded$c = ["type", "keyOverride", "aggregateRating", "trailer", "reviews", "image", "authorName", "provider", "producerName", "producerUrl", "offers", "operatingSystemName", "platformName", "translatorName", "languageName", "genreName", "publisherName"];
...
const _excluded$b = ["type", "keyOverride", "address", "contactPoints", "contactPoint"];
...
const _excluded$a = ["type", "keyOverride", "mainEntity"];
...
const _excluded$9 = ["type", "keyOverride"];
...
const _excluded$8 = ["type", "keyOverride"];
...
const _excluded$7 = ["type", "keyOverride", "courseName", "provider"];
...
const _excluded$6 = ["type", "keyOverride", "itemListElements"];
...
const _excluded$5 = ["type", "id", "keyOverride", "aggregateRating"];
...
const _excluded$4 = ["type", "keyOverride", "url", "title", "images", "datePublished", "dateModified", "authorName", "publisherName", "publisherLogo", "description", "isAccessibleForFree"];
...
const _excluded$3 = ["keyOverride", "reviewedBy"];
...
const _excluded$2 = ["type", "keyOverride"];
...
const _excluded$1 = ["type", "keyOverride", "image", "estimatedCost", "supply", "tool", "step"];
...
const _excluded = ["keyOverride", "images"];
